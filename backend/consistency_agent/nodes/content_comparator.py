...
- 누락·불충분 판정은 표준조항의 **핵심 취지나 의무가 의미적으로 결여된 경우에만** 해당됩니다.

**표현 형식에 대한 원칙**
- 목록·표 형식과 서술형 표현의 차이는 중요하지 않습니다.  
- 같은 의미를 담고 있다면 표현 방식이 달라도 동일하게 간주하십시오.
- 단어·순서·문체 차이는 문제로 보지 마십시오. 의미가 유지되면 충실한 것으로 평가하십시오.
                ...
                messages=[
                    {
                        ...
                        "content": """
당신은 데이터 계약서 전문 분석가입니다.  
당신의 임무는 “표준계약서”의 조항들과 “사용자 계약서”의 조항을 비교하여, 사용자가 표준계약서의 핵심 취지를 얼마나 충실히 반영했는지를 평가하는 것입니다.
