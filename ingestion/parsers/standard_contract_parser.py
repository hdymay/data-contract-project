...
class StandardContractParser:
    ...
    def parse_with_mode(self, pdf_path: Path, mode: str = "rawdict") -> Any:
        ...
        Args:
            pdf_path: PDF 파일 경로
            mode: 추출 모드 (text, blocks, dict, json, rawdict, rawjson, markdown)
            
        Returns:
            파싱된 데이터 (모드에 따라 형식이 다름)
        """
